    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.withdraws.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tanggal_withdraw') ? 'is-invalid' : '' }}" type="text" name="tanggal_withdraw" id="tanggal_withdraw" value="{{ old('tanggal_withdraw') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jumlah_withdraw') ? 'is-invalid' : '' }}" type="number" name="jumlah_withdraw" id="jumlah_withdraw" value="{{ old('jumlah_withdraw', '') }}" step="1">
